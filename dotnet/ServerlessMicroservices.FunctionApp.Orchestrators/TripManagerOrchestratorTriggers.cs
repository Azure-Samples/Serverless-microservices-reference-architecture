...
namespace ServerlessMicroservices.FunctionApp.Orchestrators
{
    public static class TripManagerOrchestratorTriggers
    {
        ...
        public static async Task StartTripManagerViaQueueTrigger(
            [DurableClientAttribute] IDurableOrchestrationClient context,
        ...
        /** PRIVATE **/
        private static async Task StartInstance(IDurableOrchestrationClient context, TripItem trip, string instanceId, ILogger log)
        {
            try
            {
        ...
        private static async Task TeminateInstance(IDurableOrchestrationClient context, string instanceId, ILogger log)
        {
            try
            {
